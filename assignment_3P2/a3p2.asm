...
#                         mean = PopulateArray1223(a1, a2, a3, used1, &used2, &used3);
					####################(10)####################
					addi $a0, $sp, 192		#1st arg: &a1[0]
					addi $a1, $sp, 240		#2nd ard: &a2[0]
					addi $a2, $sp, 288
					lw $a3, 188($sp)
					
					addi $t0, $sp, 184
					sw $t0, 16($sp)			#store in arg5
					addi $t0, $sp, 180
					sw $t0, 20($sp)			#store in arg6
...
#                   hopPtr3 = a3 + *used3Ptr - 1;
					lw $v1, 0($a1)				#load used3Ptr
					addi $v1, $v1, -1			#used3Ptr - 1
					sll $v1, $v1, 2				# + *used3Ptr - 1
...
#                       *endPtr2;
					...
					sw $s0, 0($sp)				#save $s0 from caller
					# BODY:
